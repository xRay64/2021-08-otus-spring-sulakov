...
class AuthorControllerTest {
    ...
    @Test
    @DisplayName("не возвращать из-за отсутствия аутентификации")
    void shouldNotReturnAddAuthorForm() throws Exception {
    ...
    @Test
    @DisplayName("не возвращать из-за отсутствия аутентификации")
    void shouldNotReturnAuthorEditForm() throws Exception {
