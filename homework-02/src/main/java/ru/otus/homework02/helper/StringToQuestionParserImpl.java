...
public class StringToQuestionParserImpl implements StringToQuestionParser {
    ...
    public Question parseStringToQuestion(String inputString) {
        ...
        if (strings[0].isEmpty()) {
            throw new StringParserQuizRuntimeException("The inputString is empty");
        }
        ...
        try {
            ...
            throw new StringParserQuizRuntimeException("Strings in CSV file dose not match correct format");
        }
